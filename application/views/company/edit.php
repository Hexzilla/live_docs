		...
		<div class="box box-info">
			...
			<div class="box-body">
							...
							<div id="partner_list">
								<?php if (!empty($partners)) { ?>
									<?php foreach ($partners as $partner) { ?>
										<div class="my_delete_my" id="company_partner_<?php echo $partner['partner_id']; ?>">
											<input type="hidden" name="partner_id[]" value="<?php echo $partner['partner_id']; ?>" class="rolesHidden">
											<span class="class_lists"><?php echo $partner['partner_company_name']; ?></span><label data-id="<?php echo $partner['partner_id']; ?>" class="ic_delete_partners"><i class="fa fa-trash" aria-hidden="true"></i></label>
										</div>
									<?php } ?>
								<?php } ?>
							</div>
							...
							<div id="list_boxs">
								<?php if (!empty($custome)) { ?>
									<?php foreach ($custome as $comp) { ?>
										<div class="my_delete_my" id="my_deletes<?php echo $comp['id']; ?>">
											<input type="hidden" value="<?php echo $comp['customer_id']; ?>" class="rolesHidden"><span class="class_lists"><?php echo $comp['Customer_name']; ?></span><label data-id="<?php echo $comp['id']; ?>" class="my_deletes"><i class="fa fa-trash" aria-hidden="true"></i></label>
										</div>
									<?php } ?>
								<?php } ?>
							</div>
				...
				<div class="row">
					<div class="col-md-6">
						<?php
							$active_state = ($company['status'] == 1 || $this->input->post('active') === 'on');
...
<script type="text/javascript">
	function selectPartner(val) {
		var res = val.split(",")
		var parterId = "#" + "company_partner_" + res[0];
