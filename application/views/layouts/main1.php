<?php
    if (isset($this->session->logged_in) && $this->session->logged_in) {
        ...
        $userGroup = $this->User_group_model->get_user_group($user['user_group_id']);
    } else {
        redirect('/login');
    }
?>
		...
		if(!empty($user['image'])){
			...
			$image="default_avatar_male.jpg";
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <p>
                                        <?php echo $user['fullname'], " ", $user['fullname']?> - <?php echo $userGroup['name']?>
                                    </p>
                                    </li>
                                    <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><?php echo $user['username'], " ", $user['fullname']?></p>
      ...
      <!-- /.search form -->
                    <ul class="sidebar-menu">
                        ...
                        <li>
						 ...
						 <li>
                            <a href="<?php echo site_url('search/index');?>"><i class="fa fa-search"></i> Search</a>
					...
					<!--	<li>
                        ...
                        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i>
                            <span>  منتهية بعد 15 يوم (<?php echo $this->Document_model->count_warning() ?>)</span></a>
                        </li>
                        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i>
                            <span>  منتهية بعد 30 يوم (<?php echo $this->Document_model->count_information() ?>)</span></a>
                        </li>		 
                    </ul>
                </section>
                <!-- /.sidebar -->
